...
--
-- Hôte : localhost:3307
-- Généré le : mar. 11 avr. 2023 à 14:52
...
--
CREATE DATABASE IF NOT EXISTS `customer360_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `customer360_db`;
...
(1, 'NEWHAYLA100BEZZ', 'HAYLA BEZZEF 100', 'BUNDLE', 100, 0, 150, 0, 0.5, 3),
(4, 'NEWHAYLA150BEZZ', 'HAYLA BEZZEF 150', 'BUNDLE', 150, 0, 300, 0, 2, 3),
(5, 'NEWHAYLA500BEZZ', 'HAYLA BEZZEF 500', 'BUNDLE', 500, 0, 750, 0, 3, 3),
(6, 'NEWHAYLA2000BEZZ', 'HAYLA BEZZEF 2000', 'BUNDLE', 2000, 0, 7000, 0, 60, 3),
(7, 'NEWHAYLA1500BEZZ', 'HAYLA BEZZEF 1500', 'BUNDLE', 1500, 0, 2000, 0, 25, 3),
(8, 'NEWHAYLA1200BEZZ', 'HAYLA BEZZEF 1200', 'BUNDLE', 1200, 0, 1500, 0, 10, 3),
(9, 'NEWHAYLA1200MAX', 'HAYLA MAXI 1200', 'BUNDLE', 1200, 0, 1500, 0, 10, 4),
(10, 'NEWHAYLA2000MAX', 'HAYLA MAXI 2000', 'BUNDLE', 2000, 0, 4000, 0, 60, 4),
(11, 'NEWHAYLA100MAX', 'HAYLA MAXI 100', 'BUNDLE', 100, 0, 150, 0, 1, 4),
(12, 'NEWHAYLA1500MAX', 'HAYLA MAXI 1500', 'BUNDLE', 1500, 0, 2000, 0, 25, 4),
(13, 'NEWHAYLA500MAX', 'HAYLA MAXI 500', 'BUNDLE', 500, 0, 750, 0, 7, 4),
(14, 'low100Value', 'Djezzy ZID 100', 'BUNDLE', 100, 0, 150, 0, 1, 5),
(15, 'low1000Value', 'Djezzy ZID 1000', 'BUNDLE', 1000, 0, 1300, 0, 10, 5);
...
('root', '{\"angular_direct\":\"angular\",\"relation_lines\":\"true\",\"snap_to_grid\":\"off\",\"full_screen\":\"on\",\"small_big_all\":\"v\"}');
...
('root', '[{\"db\":\"customer360_db\",\"table\":\"reclamations\"},{\"db\":\"customer360_db\",\"table\":\"subscriptions\"},{\"db\":\"customer360_db\",\"table\":\"behaviours\"},{\"db\":\"customer360_db\",\"table\":\"subscriptiontypes\"},{\"db\":\"customer360_db\",\"table\":\"segments\"},{\"db\":\"customer360_db\",\"table\":\"consumptions\"},{\"db\":\"customer360_db\",\"table\":\"users\"},{\"db\":\"customer360_db\",\"table\":\"subscribers\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__bookmark\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__recent\"}]');
...
('customer360', 'behaviours', 'sex'),
('customer360', 'employees', 'groupEmployee'),
('customer360_db', 'reclamations', 'reclamationText'),
('customer360_db', 'users', 'firstName');
...
('root', '2023-04-11 12:52:11', '{\"Console\\/Mode\":\"collapse\",\"FirstDayOfCalendar\":7,\"Server\\/hide_db\":\"\",\"2fa\":{\"type\":\"db\",\"backend\":\"\",\"settings\":[]},\"lang\":\"fr\"}');
...
USE `test`;
--
-- Base de données : `testttt`
--
CREATE DATABASE IF NOT EXISTS `testttt` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `testttt`;
...
CREATE TABLE `employees` (
  ...
  `groupEmployee` varchar(100) NOT NULL,
  `lastNameEmployee` varchar(100) NOT NULL,
  `firstNameEmployee` varchar(100) NOT NULL,
  `birthDateEmployee` date NOT NULL,
  `salesNumberEmployee` float NOT NULL,
  `IDEmployee_Superior` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `package` (
  ...
  `dataAvailable` int(11) DEFAULT NULL,
  `callAvailable` int(11) DEFAULT NULL,
  `SMSAvailable` int(11) DEFAULT NULL,
  `IDSubscription_foreign` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `segments` (
  ...
  `categorySegment` set('B2C','B2B') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `subscription` (
  `IDSubscription` int(11) NOT NULL,
  `paymentTypeSub` set('Postpaid','Prepaid','Hybrid') NOT NULL,
  `pricingSub` int(11) NOT NULL,
  `IDSegment_foreign` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `behaviours`
  ADD PRIMARY KEY (`MSISDN`),
  ADD KEY `recurrentPackageCodeOffre1Hyb` (`recurrentPackageCodeOffre1Hyb`),
  ADD KEY `recurrentPackageCodeOffre1Post` (`recurrentPackageCodeOffre1Post`),
  ADD KEY `recurrentPackageCodeOffre2Hyb` (`recurrentPackageCodeOffre2Hyb`),
  ADD KEY `recurrentPackageCodeOffre2Post` (`recurrentPackageCodeOffre2Post`),
  ADD KEY `subscriptionTypeCodeOffre1Hyb` (`subscriptionTypeCodeOffre1Hyb`),
  ADD KEY `subscriptionTypeCodeOffre1Post` (`subscriptionTypeCodeOffre1Post`),
  ADD KEY `subscriptionTypeCodeOffre2Hyb` (`subscriptionTypeCodeOffre2Hyb`),
  ADD KEY `subscriptionTypeCodeOffre2Post` (`subscriptionTypeCodeOffre2Post`);
...
ALTER TABLE `employees`
  ...
  ADD KEY `IDEmployee_Superior` (`IDEmployee_Superior`);
...
ALTER TABLE `package`
  ...
  ADD KEY `IDSubscription_foreign` (`IDSubscription_foreign`);
...
ALTER TABLE `subscription`
  ...
  ADD KEY `IDSegment_foreign` (`IDSegment_foreign`);
...
--
-- Contraintes pour la table `behaviours`
--
ALTER TABLE `behaviours`
  ADD CONSTRAINT `behaviours_ibfk_1` FOREIGN KEY (`recurrentPackageCodeOffre1Hyb`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_2` FOREIGN KEY (`recurrentPackageCodeOffre1Post`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_3` FOREIGN KEY (`recurrentPackageCodeOffre2Hyb`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_4` FOREIGN KEY (`recurrentPackageCodeOffre2Post`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_5` FOREIGN KEY (`subscriptionTypeCodeOffre1Hyb`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_6` FOREIGN KEY (`subscriptionTypeCodeOffre1Post`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_7` FOREIGN KEY (`subscriptionTypeCodeOffre2Hyb`) REFERENCES `package` (`IDPackage`),
  ADD CONSTRAINT `behaviours_ibfk_8` FOREIGN KEY (`subscriptionTypeCodeOffre2Post`) REFERENCES `package` (`IDPackage`);

--
-- Contraintes pour la table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`IDEmployee_Superior`) REFERENCES `employees` (`IDEmployee`);

--
-- Contraintes pour la table `package`
--
ALTER TABLE `package`
  ADD CONSTRAINT `package_ibfk_1` FOREIGN KEY (`IDSubscription_foreign`) REFERENCES `subscription` (`IDSubscription`);

--
-- Contraintes pour la table `subscription`
--
ALTER TABLE `subscription`
  ADD CONSTRAINT `subscription_ibfk_1` FOREIGN KEY (`IDSegment_foreign`) REFERENCES `segments` (`IDSegment`);
--
-- Base de données : `we_love_food`
--
CREATE DATABASE IF NOT EXISTS `we_love_food` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `we_love_food`;
...
(1, 1, 0, 'ok', '2023-03-03 17:19:07', 3);
